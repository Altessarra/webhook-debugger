export const uiCopy = {
  ...
  landingDescription:
    "Create an inbox, send a request, and see exactly what arrived — headers, query, and payload included.",
  createInbox: "Create inbox",
  newInbox: "New inbox",
  emptyInspector: "Choose a request to inspect.",
  emptyInspectorDescription:
    "Captured requests will appear here with their raw payload ready to read, copy, and replay.",
  requestHistory: "Request history",
  waitingForRequests: "Waiting for requests.",
  waitingDescription:
    "Send a webhook to the endpoint above. New requests will arrive here in real time.",
  copy: "Copy",
  copied: "Copied",
  replay: "Replay",
