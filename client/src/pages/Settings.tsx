  ...
  return (
    <section className="route-page settings-page">
      <div className="route-page-header">
        ...
        <p>
          These settings are intentionally kept in this file so you can extend
          them as the debugger grows.
        </p>
      </div>
      <div className="settings-grid">
        <section className="settings-card">
          <div>
            ...
            <h2>Theme</h2>
            <p>
              Choose the surface that feels best while you inspect requests.
            </p>
          </div>
        ...
        <section className="settings-card settings-card-muted">
          <div>
            ...
            <p>
              This card is ready for inbox preferences, retention controls, or
              integrations you want to add next.
            </p>
          </div>
        </section>
      </div>
